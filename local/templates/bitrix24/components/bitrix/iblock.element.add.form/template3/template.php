		...
		<div class="card hoverable" style="height: 280px;;;text-align:center;background-image: url(/upload/medialibrary/a36/moyki_hd_7_18_c.png);background-position: -20px 10px;background-repeat: no-repeat;background-size: contain;">
			...
			<?foreach($kolesa as $snKol):?>
				<?if($snKol < $koles):?>
					...
					<?else:?>
						<p style="text-align:center; margin-bottom:-15px;"><input <?if(isset($_POST['PROPERTY[235][<?=$snKol;?>]']) && empty($_POST['PROPERTY[235][<?=$snKol;?>]'])):?>disabled="disabled"<?endif;?> onchange="if (this.checked) {Materialize.toast('<?=$arResult["PROPERTY_LIST_FULL"]["201"]["NAME"]?> отмечена для <?=$snKol+1;?> диска', 4000)} else {Materialize.toast('Отменена <?=mb_strtolower($arResult["PROPERTY_LIST_FULL"]["201"]["NAME"])?> для <?=$snKol+1;?> диска', 4000)}" type="checkbox" class="property-201-<?=$snKol;?>" id="property-201-<?=$snKol;?>">
					<?endif;?>
		...
		<div class="card hoverable" style="height: 280px;;;text-align:center;background-image: url(/upload/medialibrary/092/science_chemistry_icon.png);background-position: -100px 10px;background-repeat: no-repeat;background-size: contain;">
			...
			<?foreach($kolesa as $snKol):?>
				<?if($snKol < $koles):?>
					...
					<?else:?>
						<p style="text-align:center; margin-bottom:-15px;"><input <?if(isset($arResult["ELEMENT_PROPERTIES"]["202"][$snKol]["VALUE"]) and !empty($arResult["ELEMENT_PROPERTIES"]["202"][$snKol]["VALUE"])):?><?else:?>disabled="disabled" data-tooltip="Необходимо выполнить подготовку к смывке"<?endif;?> onchange="if (this.checked) {Materialize.toast('<?=$arResult["PROPERTY_LIST_FULL"]["204"]["NAME"]?> отмечена для <?=$snKol+1;?> диска', 4000)} else {Materialize.toast('Отменена <?=mb_strtolower($arResult["PROPERTY_LIST_FULL"]["204"]["NAME"])?> для <?=$snKol+1;?> диска', 4000)}" type="checkbox" class="property-204-<?=$snKol;?>" id="property-204-<?=$snKol;?>">
					<?endif;?>
		...
		<div class="card hoverable" style="height: 280px;;;text-align:center;background-image: url(/upload/medialibrary/092/science_chemistry_icon.png);background-position: -100px 10px;background-repeat: no-repeat;background-size: contain;">
			...
			<?foreach($kolesa as $snKol):?>
				<?if($snKol < $koles):?>
					...
					<?else:?>
						<p style="text-align:center; margin-bottom:-15px;"><input <?if(isset($arResult["ELEMENT_PROPERTIES"]["205"][$snKol]["VALUE"]) and !empty($arResult["ELEMENT_PROPERTIES"]["205"][$snKol]["VALUE"])):?><?else:?>disabled="disabled"<?endif;?> onchange="if (this.checked) {Materialize.toast('<?=$arResult["PROPERTY_LIST_FULL"]["207"]["NAME"]?> отмечена для <?=$snKol+1;?> диска', 4000)} else {Materialize.toast('Отменена <?=mb_strtolower($arResult["PROPERTY_LIST_FULL"]["207"]["NAME"])?> для <?=$snKol+1;?> диска', 4000)}" type="checkbox" class="property-207-<?=$snKol;?>" id="property-207-<?=$snKol;?>">
					<?endif;?>
...
<?if(!empty($arResult["ELEMENT_PROPERTIES"]["131"]["0"]["VALUE"]) and empty($arResult["ELEMENT_PROPERTIES"]["153"]["0"]["VALUE"])):?>
	<div class="col s3" id="b<?=$in++;?>"> 
		<div class="card hoverable" style="height: 280px;;;text-align:center;background-image: url(/upload/medialibrary/24b/3561970_9.jpg);background-position: -127px 21px;background-repeat: no-repeat;background-size: contain;">
			<div class="card-image teal white-text" style="padding:5px;">
				<h6 class="box-title">Диски коррозийные? </h6>
			</div>
		...
		<div class="card hoverable" style="height: 280px;;;text-align:center;background-image: url(/upload/medialibrary/24b/3561970_9.jpg);background-position: -127px 21px;background-repeat: no-repeat;background-size: contain;">
			...
			<?foreach($kolesa as $snKol):?>
				<?if($snKol < $koles):?>
					...
					<?else:?>
						<p style="text-align:center; margin-bottom:-15px;"><input <?if(isset($arResult["ELEMENT_PROPERTIES"]["208"][$snKol]["VALUE"]) and !empty($arResult["ELEMENT_PROPERTIES"]["208"][$snKol]["VALUE"])):?><?else:?>disabled="disabled"<?endif;?> onchange="if (this.checked) {Materialize.toast('<?=$arResult["PROPERTY_LIST_FULL"]["243"]["NAME"]?> отмечена для <?=$snKol+1;?> диска', 4000)} else {Materialize.toast('Отменена <?=mb_strtolower($arResult["PROPERTY_LIST_FULL"]["243"]["NAME"])?> для <?=$snKol+1;?> диска', 4000)}" type="checkbox" class="property-243-<?=$snKol;?>" id="property-243-<?=$snKol;?>">
					<?endif;?>
		...
		<div class="card hoverable" style="height: 280px;;;text-align:center;background-image: url(/upload/medialibrary/24b/3561970_9.jpg);background-position: -127px 21px;background-repeat: no-repeat;background-size: contain;">
			...
			<?foreach($kolesa as $snKol):?>
				<?if($snKol < $koles):?>
					...
					<?else:?>
						<p style="text-align:center; margin-bottom:-15px;"><input <?if(isset($arResult["ELEMENT_PROPERTIES"]["208"][$snKol]["VALUE"]) and !empty($arResult["ELEMENT_PROPERTIES"]["208"][$snKol]["VALUE"])):?><?else:?>disabled="disabled"<?endif;?> onchange="if (this.checked) {Materialize.toast('<?=$arResult["PROPERTY_LIST_FULL"]["332"]["NAME"]?> отмечена для <?=$snKol+1;?> диска', 4000)} else {Materialize.toast('Отменена <?=mb_strtolower($arResult["PROPERTY_LIST_FULL"]["332"]["NAME"])?> для <?=$snKol+1;?> диска', 4000)}" type="checkbox" class="property-332-<?=$snKol;?>" id="property-332-<?=$snKol;?>">
					<?endif;?>
		...
		<div class="card hoverable" style="height: 280px;;;text-align:center;background-image: url(/upload/medialibrary/dab/22322.jpg);background-position: -53px 42px;background-repeat: no-repeat;background-size: contain;">
			...
			<?foreach($kolesa as $snKol):?>
				<?if($snKol < $koles):?>
					...
					<?else:?>
						<p style="text-align:center; margin-bottom:-15px;"><input <?if(isset($arResult["ELEMENT_PROPERTIES"]["244"][$snKol]["VALUE"]) and !empty($arResult["ELEMENT_PROPERTIES"]["244"][$snKol]["VALUE"])):?><?else:?><?if(isset($arResult["ELEMENT_PROPERTIES"]["333"][$snKol]["VALUE"]) and !empty($arResult["ELEMENT_PROPERTIES"]["333"][$snKol]["VALUE"])):?><?else:?>disabled="disabled"<?endif;?><?endif;?> onchange="if (this.checked) {Materialize.toast('<?=$arResult["PROPERTY_LIST_FULL"]["246"]["NAME"]?> отмечена для <?=$snKol+1;?> диска', 4000)} else {Materialize.toast('Отменена <?=mb_strtolower($arResult["PROPERTY_LIST_FULL"]["246"]["NAME"])?> для <?=$snKol+1;?> диска', 4000)}" type="checkbox" class="property-246-<?=$snKol;?>" id="property-246-<?=$snKol;?>">
					<?endif;?>
		...
		<div class="card hoverable" style="height: 280px;;;text-align:center;background-image: url(/upload/medialibrary/dab/22322.jpg);background-position: -53px 42px;background-repeat: no-repeat;background-size: contain;">
			...
			<?foreach($kolesa as $snKol):?>
				<?if($snKol < $koles):?>
					...
					<?else:?>
						<p style="text-align:center; margin-bottom:-15px;"><input <?if(isset($arResult["ELEMENT_PROPERTIES"]["247"][$snKol]["VALUE"]) and !empty($arResult["ELEMENT_PROPERTIES"]["247"][$snKol]["VALUE"])):?><?else:?>disabled="disabled"<?endif;?> onchange="if (this.checked) {Materialize.toast('<?=$arResult["PROPERTY_LIST_FULL"]["249"]["NAME"]?> отмечена для <?=$snKol+1;?> диска', 4000)} else {Materialize.toast('Отменена <?=mb_strtolower($arResult["PROPERTY_LIST_FULL"]["249"]["NAME"])?> для <?=$snKol+1;?> диска', 4000)}" type="checkbox" class="property-249-<?=$snKol;?>" id="property-249-<?=$snKol;?>">
					<?endif;?>
			...
			<div class="card hoverable" style="height: 280px;;;text-align:center;background-image: url(/upload/medialibrary/24b/3561970_9.jpg);background-position: -127px 21px;background-repeat: no-repeat;background-size: contain;">
				...
				<?foreach($kolesa as $snKol):?>
					<?if($snKol < $koles):?>
						...
						<?else:?>
							<p style="text-align:center; margin-bottom:-15px;"><input <?if(isset($arResult["ELEMENT_PROPERTIES"]["250"][$snKol]["VALUE"]) and !empty($arResult["ELEMENT_PROPERTIES"]["250"][$snKol]["VALUE"])):?><?else:?>disabled="disabled"<?endif;?> onchange="if (this.checked) {Materialize.toast('<?=$arResult["PROPERTY_LIST_FULL"]["252"]["NAME"]?> отмечена для <?=$snKol+1;?> диска', 4000)} else {Materialize.toast('Отменена <?=mb_strtolower($arResult["PROPERTY_LIST_FULL"]["252"]["NAME"])?> для <?=$snKol+1;?> диска', 4000)}" type="checkbox" class="property-252-<?=$snKol;?>" id="property-252-<?=$snKol;?>">
						<?endif;?>
		...
		<div class="card hoverable" style="height: 280px;;;text-align:center;background-image: url(/upload/medialibrary/dab/22322.jpg);background-position: -53px 42px;background-repeat: no-repeat;background-size: contain;">
			...
			<?foreach($kolesa as $snKol):?>
				<?if($snKol < $koles):?>
					...
					<?else:?>
						<p style="text-align:center; margin-bottom:-15px;"><input <?if(isset($arResult["ELEMENT_PROPERTIES"]["250"][$snKol]["VALUE"]) and !empty($arResult["ELEMENT_PROPERTIES"]["250"][$snKol]["VALUE"])):?><?else:?>disabled="disabled"<?endif;?> onchange="if (this.checked) {Materialize.toast('<?=$arResult["PROPERTY_LIST_FULL"]["255"]["NAME"]?> отмечена для <?=$snKol+1;?> диска', 4000)} else {Materialize.toast('Отменена <?=mb_strtolower($arResult["PROPERTY_LIST_FULL"]["255"]["NAME"])?> для <?=$snKol+1;?> диска', 4000)}" type="checkbox" class="property-255-<?=$snKol;?>" id="property-255-<?=$snKol;?>">
					<?endif;?>
		...
		<div class="card hoverable" style="height: 280px;;;text-align:center;background-image: url(/upload/medialibrary/dab/22322.jpg);background-position: -53px 42px;background-repeat: no-repeat;background-size: contain;">
			...
			<?foreach($kolesa as $snKol):?>
				<?if($snKol < $koles):?>
					...
					<?else:?>
						<p style="text-align:center; margin-bottom:-15px;"><input <?if(isset($arResult["ELEMENT_PROPERTIES"]["256"][$snKol]["VALUE"]) and !empty($arResult["ELEMENT_PROPERTIES"]["256"][$snKol]["VALUE"])):?><?else:?>disabled="disabled"<?endif;?> onchange="if (this.checked) {Materialize.toast('<?=$arResult["PROPERTY_LIST_FULL"]["285"]["NAME"]?> отмечена для <?=$snKol+1;?> диска', 4000)} else {Materialize.toast('Отменена <?=mb_strtolower($arResult["PROPERTY_LIST_FULL"]["285"]["NAME"])?> для <?=$snKol+1;?> диска', 4000)}" type="checkbox" class="property-285-<?=$snKol;?>" id="property-285-<?=$snKol;?>">
					<?endif;?>
		...
		<div class="card hoverable" style="height: 280px;;;text-align:center;background-image: url(/upload/medialibrary/dab/22322.jpg);background-position: -53px 42px;background-repeat: no-repeat;background-size: contain;">
			...
			<?foreach($kolesa as $snKol):?>
				<?if($snKol < $koles):?>
					...
					<?else:?>
						<p style="text-align:center; margin-bottom:-15px;"><input <?if(isset($arResult["ELEMENT_PROPERTIES"]["286"][$snKol]["VALUE"]) and !empty($arResult["ELEMENT_PROPERTIES"]["286"][$snKol]["VALUE"])):?><?else:?>disabled="disabled"<?endif;?> onchange="if (this.checked) {Materialize.toast('<?=$arResult["PROPERTY_LIST_FULL"]["258"]["NAME"]?> отмечена для <?=$snKol+1;?> диска', 4000)} else {Materialize.toast('Отменена <?=mb_strtolower($arResult["PROPERTY_LIST_FULL"]["258"]["NAME"])?> для <?=$snKol+1;?> диска', 4000)}" type="checkbox" class="property-258-<?=$snKol;?>" id="property-258-<?=$snKol;?>">
					<?endif;?>
		...
		<div class="card hoverable" style="height: 280px;;;text-align:center;background-image: url(/upload/medialibrary/dab/22322.jpg);background-position: -53px 42px;background-repeat: no-repeat;background-size: contain;">
			...
			<?foreach($kolesa as $snKol):?>
				<?if($snKol < $koles):?>
					...
					<?else:?>
						<p style="text-align:center; margin-bottom:-15px;"><input <?if(isset($arResult["ELEMENT_PROPERTIES"]["259"][$snKol]["VALUE"]) and !empty($arResult["ELEMENT_PROPERTIES"]["259"][$snKol]["VALUE"])):?><?else:?>disabled="disabled"<?endif;?> onchange="if (this.checked) {Materialize.toast('<?=$arResult["PROPERTY_LIST_FULL"]["261"]["NAME"]?> отмечена для <?=$snKol+1;?> диска', 4000)} else {Materialize.toast('Отменена <?=mb_strtolower($arResult["PROPERTY_LIST_FULL"]["261"]["NAME"])?> для <?=$snKol+1;?> диска', 4000)}" type="checkbox" class="property-261-<?=$snKol;?>" id="property-261-<?=$snKol;?>">
					<?endif;?>
		...
		<div class="card hoverable" style="height: 280px;;;text-align:center;background-image: url(/upload/medialibrary/38e/podlinnaya_3_m_nazhdachnaya_bumaga_401q_ace_avtomobilnaya_kraska_spetsialnyy_nazhdachnaya_bumaga_1500_vody_nazhdachnaya_bumaga.jpg);background-position: -127px 21px;background-repeat: no-repeat;background-size: contain;">
			...
			<?foreach($kolesa as $snKol):?>
				<?if($snKol < $koles):?>
					...
					<?else:?>
						<p style="text-align:center; margin-bottom:-15px;"><input <?if(isset($arResult["ELEMENT_PROPERTIES"]["271"][$snKol]["VALUE"]) and !empty($arResult["ELEMENT_PROPERTIES"]["271"][$snKol]["VALUE"])):?><?else:?>disabled="disabled"<?endif;?> onchange="if (this.checked) {Materialize.toast('<?=$arResult["PROPERTY_LIST_FULL"]["273"]["NAME"]?> отмечена для <?=$snKol+1;?> диска', 4000)} else {Materialize.toast('Отменена <?=mb_strtolower($arResult["PROPERTY_LIST_FULL"]["273"]["NAME"])?> для <?=$snKol+1;?> диска', 4000)}" type="checkbox" class="property-273-<?=$snKol;?>" id="property-273-<?=$snKol;?>">
					<?endif;?>
		...
		<div class="card hoverable" style="height: 280px;;;text-align:center;background-image: url(/upload/medialibrary/da8/price_wheels.2.png);background-position: -125px 27px;background-repeat: no-repeat;background-size: contain;">
			...
			<?foreach($kolesa as $snKol):?>
				<?if($snKol < $koles):?>
					...
					<?else:?>
						<p style="text-align:center; margin-bottom:-15px;"><input <?if(isset($arResult["ELEMENT_PROPERTIES"]["274"][$snKol]["VALUE"]) and !empty($arResult["ELEMENT_PROPERTIES"]["274"][$snKol]["VALUE"])):?><?else:?>disabled="disabled"<?endif;?> onchange="if (this.checked) {Materialize.toast('<?=$arResult["PROPERTY_LIST_FULL"]["276"]["NAME"]?> отмечена для <?=$snKol+1;?> диска', 4000)} else {Materialize.toast('Отменена <?=mb_strtolower($arResult["PROPERTY_LIST_FULL"]["276"]["NAME"])?> для <?=$snKol+1;?> диска', 4000)}" type="checkbox" class="property-276-<?=$snKol;?>" id="property-276-<?=$snKol;?>">
					<?endif;?>
			...
			<div class="card hoverable" style="height: 280px;;;text-align:center;background-image: url(/upload/medialibrary/eb3/diski_y.png);background-position: -125px 27px;background-repeat: no-repeat;background-size: contain;">
				...
				<?foreach($kolesa as $snKol):?>
					<?if($snKol < $koles):?>
						...
						<?else:?>
							<p style="text-align:center; margin-bottom:-15px;"><input <?if(isset($arResult["ELEMENT_PROPERTIES"]["265"][$snKol]["VALUE"]) and !empty($arResult["ELEMENT_PROPERTIES"]["265"][$snKol]["VALUE"])):?><?else:?>disabled="disabled"<?endif;?> onchange="if (this.checked) {Materialize.toast('<?=$arResult["PROPERTY_LIST_FULL"]["279"]["NAME"]?> отмечена для <?=$snKol+1;?> диска', 4000)} else {Materialize.toast('Отменена <?=mb_strtolower($arResult["PROPERTY_LIST_FULL"]["279"]["NAME"])?> для <?=$snKol+1;?> диска', 4000)}" type="checkbox" class="property-279-<?=$snKol;?>" id="property-279-<?=$snKol;?>">
						<?endif;?>
		...
		<div class="card hoverable" style="height: 280px;;;text-align:center;background-image: url(/upload/medialibrary/868/prozrachnyiy_steklyannyiy_shar_smotrovuyu_ploschadku_timesunioncom_101.jpg);background-position: -125px 27px;background-repeat: no-repeat;background-size: contain;">
			...
			<?foreach($kolesa as $snKol):?>
				<?if($snKol < $koles):?>
					...
					<?else:?>
						<p style="text-align:center; margin-bottom:-15px;"><input <?if(isset($arResult["ELEMENT_PROPERTIES"]["277"][$snKol]["VALUE"]) and !empty($arResult["ELEMENT_PROPERTIES"]["277"][$snKol]["VALUE"])):?><?else:?><?if(isset($arResult["ELEMENT_PROPERTIES"]["262"][$snKol]["VALUE"]) and !empty($arResult["ELEMENT_PROPERTIES"]["262"][$snKol]["VALUE"])):?><?else:?>disabled="disabled"<?endif;?><?endif;?> onchange="if (this.checked) {Materialize.toast('<?=$arResult["PROPERTY_LIST_FULL"]["282"]["NAME"]?> отмечена для <?=$snKol+1;?> диска', 4000)} else {Materialize.toast('Отменена <?=mb_strtolower($arResult["PROPERTY_LIST_FULL"]["282"]["NAME"])?> для <?=$snKol+1;?> диска', 4000)}" type="checkbox" class="property-282-<?=$snKol;?>" id="property-282-<?=$snKol;?>">
					<?endif;?>
		...
		<div class="card hoverable" style="height: 280px;;;text-align:center;background-image: url(/upload/medialibrary/4b0/251112_4.png);background-position: -163px 26px;background-repeat: no-repeat;background-size: contain;">
			...
			<?foreach($kolesa as $snKol):?>
				<?if($snKol < $koles):?>
					...
					<?else:?>
						<p style="text-align:center; margin-bottom:-15px;"><input <?if(isset($arResult["ELEMENT_PROPERTIES"]["238"][$snKol]["VALUE"]) and !empty($arResult["ELEMENT_PROPERTIES"]["238"][$snKol]["VALUE"])):?><?else:?>disabled="disabled"<?endif;?> onchange="if (this.checked) {Materialize.toast('<?=$arResult["PROPERTY_LIST_FULL"]["240"]["NAME"]?> отмечена для <?=$snKol+1;?> диска', 4000)} else {Materialize.toast('Отменена <?=mb_strtolower($arResult["PROPERTY_LIST_FULL"]["240"]["NAME"])?> для <?=$snKol+1;?> диска', 4000)}" type="checkbox" class="property-240-<?=$snKol;?>" id="property-240-<?=$snKol;?>">
					<?endif;?>
...
<div id="b<?=$in++;?>" class="col s3" >
	<div class="card hoverable" style="height: 280px;;;text-align:center;background-image: url(/upload/medialibrary/a9f/monty_1000.png);background-position: -19px 10px;background-repeat: no-repeat;background-size: contain;">
		...
		<?foreach($kolesa as $snKol):?>
			<?if($snKol < 8):?>
				<div class="col s2"><?=$snkol++;?></div><div class="col s10"><?if(!empty($arResult["ELEMENT_PROPERTIES"]["323"][$snKol]["VALUE"])):?><?else:?><input data-cell="LL<?=$bb++;?>" type="text" class="property323-<?=$snKol;?>" name="PROPERTY[323][<?=$snKol;?>]" size="25" value="<?=$arResult["ELEMENT_PROPERTIES"]["323"][$snKol]["VALUE"]?>"><?endif;?></div>
				<?if(!empty($arResult["ELEMENT_PROPERTIES"]["323"][$snKol]["VALUE"])):?>
					<span style="color:green;"><?=$arResult["ELEMENT_PROPERTIES"]["323"][$snKol]["VALUE"]?> <?=$arResult["ELEMENT_PROPERTIES"]["324"][$snKol]["VALUE"]?></span><span style="font-size: 9px;margin: 15px -9px;position: absolute;color: red;"><?=$arResult["ELEMENT_PROPERTIES"]["325"][$snKol]["VALUE"]?></span>
				<?else:?>
				<?endif;?>
				<input  data-formula="IF(LL<?=$bc++;?><>0,UP1,0)" hidden type="text" class="property324-<?=$snKol;?>" name="PROPERTY[324][<?=$snKol;?>]" size="25" value="<?=$arResult["ELEMENT_PROPERTIES"]["324"][$snKol]["VALUE"]?>">
				<input  data-formula="IF(LL<?=$bd++;?><>0,TN1,0)" hidden type="text" class="property325-<?=$snKol;?>" name="PROPERTY[325][<?=$snKol;?>]" size="25" value="<?=$arResult["ELEMENT_PROPERTIES"]["325"][$snKol]["VALUE"]?>">
			<?endif;?>
		<?endforeach;?>
	</div>
</div>
