...
<div class="collection col s12">
	...
	<div class="collection-item"><div class="row"><div class="col s6"><input class="btn" type="submit" name="iblock_submit" value="Сохранить"></div><div class="col s6"><?if (!empty($arResult["ERRORS"])):?>
	<?ShowError(implode("<br />", $arResult["ERRORS"]))?>
<?endif;
if (strlen($arResult["MESSAGE"]) > 0):?>
	<?ShowNote($arResult["MESSAGE"])?>
		<?else:?><span class="chip">Для прочих работ</span><?endif?></div></div></div>
</div>
</div>
</form>