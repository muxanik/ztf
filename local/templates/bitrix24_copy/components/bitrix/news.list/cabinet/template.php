...
<a href="zakaz.php" class="btn btn-primary">Новый заказ</a>
		...
		<?if($arParams["DISPLAY_NAME"]!="N" && $arItem["NAME"]):?>
			<h3 class="bx-newslist-title">
				...
				<?else:?>
					<?echo $arItem["NAME"]?>
				<?endif;?>
		</h3><a style="background-color: #767F8C !important;border-color: #535C69 !important;" class="btn btn-primary btn-xs" href="<?echo $arItem["DETAIL_PAGE_URL"]?>">Просмотр</a> <a class="btn btn-primary btn-xs" href="zakazc.php?edit=Y&amp;CODE=<?=$arItem["ID"]?>">Изменить</a>
		<?endif;?>
